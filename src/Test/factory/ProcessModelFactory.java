...
public class ProcessModelFactory {
    ...
    public static ProcessModel createBspSese2Start2UnitKeineZerteilungV1() {
        return new ProcessModelModifier()
                .setId("BeispielSese2Start2UnitKeineZerteilungV1")
                .setName("Beispiel SESE 2 Start 2 Unit Keine Zerteilung V1")
                .setDescription("Testbeispiel für Modularisierung SESE 2 Start 2 Unit Keine Zerteilung V1")
    ...
    public static ProcessModel createBspSese2Start2UnitKeineZerteilungV2() {
        return new ProcessModelModifier()
                .setId("BeispielSese2Start2UnitKeineZerteilungV2")
                .setName("Beispiel SESE 2 Start 2 Unit Keine Zerteilung V2")
                .setDescription("Testbeispiel für Modularisierung SESE 2 Start 2 Unit Keine Zerteilung V2")
